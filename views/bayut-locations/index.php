...
<script>
    ...
    async function fetchLocations(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm11Location&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            locationList.innerHTML = locations
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${location.ufCrm11Location || 'N/A'}</td>
    ...
    async function deleteLocation(locationId) {
        const baseUrl = 'https://b24-oy9apg.bitrix24.com/rest/9/e3hbkx5cs7wy7r7r';
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=1048&id=${locationId}`;
