...
<script>
    ...
    async function getOwner(ownerId) {
        const response = await fetch(`https://b24-oy9apg.bitrix24.com/rest/9/e3hbkx5cs7wy7r7r/crm.item.list?entityTypeId=1040&filter[ufCrm7OwnerId]=${ownerId}`);
    ...
    async function handleTransferOwnerSubmit(e) {
        ...
        const fields = {
            "ufCrm5ListingOwner": formData.get('listing_owner'),
        };
