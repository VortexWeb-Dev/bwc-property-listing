...
<script>
    ...
    function handleAddAgent(e) {
        ...
        const fields = {
            "ufCrm7AgentName": data.agentName.trim(),
            "ufCrm7AgentEmail": data.agentEmail.trim(),
            "ufCrm7AgentMobile": data.agentMobile.trim(),
            "ufCrm7AgentLicense": data.agentLicense.trim(),
        };
