...
<script>
    ...
    async function fetchProperty(id) {
        ...
        if (data.result && data.result.item) {
            ...
            document.getElementById('property-title').textContent = property.ufCrm5TitleEn || 'No title available';
            document.getElementById('property-description').innerHTML = '<pre>' + property.ufCrm5DescriptionEn + '</pre>' || 'No description available';
            document.getElementById('property-city').textContent = property.ufCrm5City || 'N/A';
            document.getElementById('property-community').textContent = property.ufCrm5Community || 'N/A';
            let priceText = property.ufCrm5Price ? formatPrice(property.ufCrm5Price) : 'N/A';
            if (property.ufCrm5RentalPeriod && property.ufCrm5RentalPrice) {
                ...
                const rentalPeriod = rentalPeriodMapping[property.ufCrm5RentalPrice] || property.ufCrm5RentalPeriod;
                priceText += `/ ${rentalPeriod}`;
            }
            document.getElementById('property-price').textContent = priceText;
            document.getElementById('property-size').textContent = property.ufCrm5Size ? `${property.ufCrm5Size} sqft` : 'N/A';
            document.getElementById('property-bedrooms').textContent = property.ufCrm5Bedroom || 'N/A';
            document.getElementById('property-bathrooms').textContent = property.ufCrm5Bathroom || 'N/A';
            document.getElementById('property-type').textContent = property.ufCrm5PropertyType || 'N/A';
            document.getElementById('property-location').textContent = property.ufCrm5Location || 'N/A';
            document.getElementById('property-status').textContent = property.ufCrm5Status || 'N/A';
            document.getElementById('property-owner').textContent = property.ufCrm5ListingOwner || 'N/A';
